...
public class BlockFullPaperPileLogic extends BlockLogicRotatable implements IPaintable {
	...
	public void setColor(World world, int x, int y, int z, DyeColor color) {
		...
		world.setBlockAndMetadataRaw(x, y, z, PaperworkBlocks.BLOCK_PAPER_PILE.id(), meta);
		world.setBlockMetadata(x, y, z, meta);
		((BlockFullPaperPileLogic) PaperworkBlocks.BLOCK_PAPER_PILE.getLogic()).setColor(world, x, y, z, color);
	}
