...
public class PaperLayerLogicPainted extends BlockLogicLayerBase implements IPainted {
	private final String itemnsp;

	public PaperLayerLogicPainted(Block<?> block, Block<?> fullblock, String itemnsp) {
